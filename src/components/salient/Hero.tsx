  ...
  return (
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      <h1 className="font-display mx-auto max-w-4xl text-4xl font-medium tracking-tight text-slate-50 sm:text-7xl">
        ...
        <span className="text-bokgreen relative sm:whitespace-nowrap">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
            className="absolute left-0 top-2/3 h-[0.58em] w-full fill-lime-400/70"
          ...
          Let&apos;s <span className="relative">build one</span> together.
        </span>{" "}
      </h1>
      ...
      <div className="mt-10 flex justify-center gap-x-6">
        ...
        <Button href="https://vimeo.com/946554155" color="white">
          <svg
            aria-hidden="true"
