...
import animatedBg from "~/images/salient/animated-bg.svg";
...
export function Hero() {
  return (
    <>
      <div
        className={
          "absolute left-0 top-24 flex h-[90vh] w-screen items-center justify-center overflow-hidden sm:h-screen"
        }
      >
        <Image
          src={animatedBg as string}
      ...
      <Container className="pb-16 pt-20 text-center drop-shadow lg:pt-32">
        <h1 className="font-display mx-auto max-w-5xl text-balance text-4xl font-medium tracking-tight text-slate-50 sm:text-7xl">
          Employee Financial Freedom{" "}
          <span className="relative text-bokgreen sm:whitespace-nowrap">
            <svg
              aria-hidden="true"
              viewBox="0 0 418 42"
              className="absolute left-0 top-2/3 -z-10 h-[0.58em] w-full fill-blue-400/70"
            ...
            <span className="relative">Invest Smart, Work Better</span>
          </span>{" "}
        </h1>
