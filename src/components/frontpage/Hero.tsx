...
import logoBbc from "~/_images/logos/bbc.svg";
import logoCbs from "~/_images/logos/cbs.svg";
import logoCnn from "~/_images/logos/cnn.svg";
import logoFastCompany from "~/_images/logos/fast-company.svg";
import logoForbes from "~/_images/logos/forbes.svg";
import logoHuffpost from "~/_images/logos/huffpost.svg";
import logoTechcrunch from "~/_images/logos/techcrunch.svg";
import logoWired from "~/_images/logos/wired.svg";
import NewsletterMiniForm from "~/components/frontpage/NewsletterMiniForm";
import welcome from "~/_images/welcome.svg";
